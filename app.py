    ...
    for i in range(num_aforos):
        with st.expander(f"Aforo {i+1}", expanded=True if i == 0 else False):
            ...
            with col2:
                ...
                perimetro = st.number_input("Perímetro (m)", min_value=0.1, max_value=50.0, value=10.0, step=0.1, 
            ...
            # Si el perímetro es 0, establecerlo como None para cálculo automático
            perimetro_valor = perimetro if perimetro > 0 else None
